// QR Code generator bundled from qrcode-terminal (MIT)
// Original QR Code for JavaScript by Kazuhiko Arase (MIT)
...
function generate(url) {
  ...
  var output = "";
  output += repeat(platte.BLACK_WHITE, moduleCount + 3) + "\n";
  ...
  if (!oddRow) output += repeat(platte.WHITE_BLACK, moduleCount + 3);
